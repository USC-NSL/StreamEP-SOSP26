...
# GPUs are available. Leave running for the whole sweep; Ctrl-C to stop. (Identical
# to the throughput-itl worker script — the interference generator is launched from
# the head over SSH and needs nothing extra here.)
set -uo pipefail
